# scenarios_17_32_combined.R  — Scenarios 17-32, all four methods including combined
...
all_scenarios <- list(
  s17 = list("Medium",    0.2, "A", "A"),
  s18 = list("Medium",    0.2, "B", "B"),
  s19 = list("Medium",    0.2, "C", "C"),
  s20 = list("Medium",    0.2, "C", "D"),
  s21 = list("Medium",    0.5, "A", "A"),
  s22 = list("Medium",    0.5, "B", "B"),
  s23 = list("Medium",    0.5, "C", "C"),
  s24 = list("Medium",    0.5, "C", "D"),
  s25 = list("Difficult", 0.0, "A", "A"),
  s26 = list("Difficult", 0.0, "B", "B"),
  s27 = list("Difficult", 0.0, "C", "C"),
  s28 = list("Difficult", 0.0, "C", "D"),
  s29 = list("Difficult", 0.2, "A", "A"),
  s30 = list("Difficult", 0.2, "B", "B"),
  s31 = list("Difficult", 0.2, "C", "C"),
  s32 = list("Difficult", 0.2, "C", "D")
)
...
if (length(args) == 0) stop("Usage:  Rscript scenarios_17_32_combined.R <17..32>")

sc_id <- paste0("s", args[1])
if (!sc_id %in% names(all_scenarios))
  stop("Scenario '", sc_id, "' not found. Valid options: 17 to 32.")
